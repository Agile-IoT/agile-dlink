...
if [ $MODULE = 'all' ] || [ $MODULE = 'DLink' ]; then
  ./scripts/stop.sh "protocol.DLink"
  ...
  # Register DLink in ProtocolManager
  qdbus org.eclipse.agail.ProtocolManager /org/eclipse/agail/ProtocolManager org.eclipse.agail.ProtocolManager.Add DLink


   java -cp org.eclipse.agail.protocol.DLinkProtocol/target/agile-dlink-protocol-1.0.0-jar-with-dependencies.jar -Djava.library.path=deps:deps/lib org.eclipse.agail.protocol.dlink.DLinkProtocol &
  echo "Started AGILE DLink protocol"
fi
