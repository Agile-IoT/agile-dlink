...
COPY org.eclipse.agail.protocol.DLinkProtocol org.eclipse.agail.protocol.DLinkProtocol

RUN cd org.eclipse.agail.protocol.DLinkProtocol && mvn package
...
COPY --from=0 $APATH/org.eclipse.agail.protocol.DLinkProtocol/target/agile-dlink-protocol-1.0.0-jar-with-dependencies.jar org.eclipse.agail.protocol.DLinkProtocol/target/agile-dlink-protocol-1.0.0-jar-with-dependencies.jar
